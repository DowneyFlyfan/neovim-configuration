            ...
            return require("codecompanion.adapters").extend("deepseek", {
                ...
                schema = {
                    model = {
                        ...
                        choices = { ["deepseek-reasoner"] = { opts = { can_reason = true } }, "deepseek-chat" },
                    },
                },
            })
        end,
        ...
        ["Code explained in Chinese Using Deepseek chat"] = {
            ...
            prompts = {
                ...
                },
                {
                    role = "user",
                    content = function(context)
                        local input = require("codecompanion.helpers.actions").get_code(context.start_line,
                            context.end_line)
...
vim.api.nvim_create_autocmd("filetype", {
    ...
    callback = function()
        ...
        -- Chat
        vim.keymap.set('n', '<space>c', ':CodeCompanionChat <CR>', { noremap = true, silent = true })
        vim.keymap.set('n', '<space>C', ':CodeCompanionChat deepseek<CR>', { noremap = true, silent = true })
